...
insert into company(company_id, company_name, category_id) values(999, 'Unknown', 200)
insert into company(company_id, company_name, category_id) values(1, 'ChloeC HQ', 202)
insert into company(company_id, company_name, category_id) values(2, 'ChloeC Birkenhead Point', 202)
insert into company(company_id, company_name, category_id) values(11, 'Desire Fashion', 201)
insert into company(company_id, company_name, category_id) values(12, 'Indikah', 201)
insert into company(company_id, company_name, category_id) values(13, 'Lovely Girl', 201)
insert into company(company_id, company_name, category_id) values(14, 'Pink Diamond', 201)
insert into company(company_id, company_name, category_id) values(15, 'So In Style', 201)
insert into company(company_id, company_name, category_id) values(16, 'Spicy Sugar', 201)
insert into company(company_id, company_name, category_id) values(17, 'Sunny Girl', 201)
insert into company(company_id, company_name, category_id) values(18, 'Wakee', 201)
...
insert into product(product_id, factory_barcode, factory_code, product_code, product_name, display_name, gender_id, summary, description, wholesale_price, retail_price, category_id, label_id, product_type_id, creation_date, last_update_date, last_update_user_id) values (1,'2PDBBQ8D4TCY3X7T21','Test Factory Code 1', 'Test Product Code 1', 'Test Product Using Dr Prescription', 'Test Display Name 1', 301, 'Test Summary 1', 'Test Description 1', 50, 500, 101, 1, 1002, current_date(), current_date(), 1)
...
insert into product_promotion(promotion_id, discount_unit_id, discount_amount, effective_from_date, product_id) values(1, 801, 12, current_date(), 1)

insert into product(product_id, product_barcode, factory_code, product_code, product_name, gender_id, summary, description, wholesale_price, retail_price, category_id, label_id, product_type_id, creation_date, last_update_date, last_update_user_id) values (2,'TestProductBarcode','Test Factory Code 2', 'Test Product Code 2', 'Test Product Name 2', 302, 'Test Summary 2', 'Test Description 2', 70, 700, 102, 2, 1003, current_date(), current_date(), 1)
...
insert into product_promotion(promotion_id, discount_unit_id, discount_amount, effective_from_date, product_id) values(2, 802, 34, current_date(), 2)
insert into product_promotion(promotion_id, discount_unit_id, discount_amount, effective_from_date, product_id) values(3, 801, 56, current_date(), 2)
...
insert into journal(journal_id, content, category_id, creation_date, last_update_date, last_update_user_id) values(1, 'test', 901, current_date(), current_date(), 1)
